...
// MD33: paths from assets/nodeblast_logo_v2.svg — pre-rotated, no
// code-based transform. Right half at full opacity, left half at 50%
// fill-opacity for the two-tone watermark look.
export const PLACEHOLDER_LOGO_SVG = `<svg class="hex-placeholder-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 234.6" aria-hidden="true">
  <g fill="currentColor">
    <path d="M237.5,162.3c11.4-11.5,18.5-27.4,18.5-45s-13.2-35.8-18.5-45-27.8-48.1-27.8-48.1C201.1,9.2,185.1,0,167.8,0h-79.7c-17.3,0-33.2,9.2-41.9,24.2h0c-7.5,13.1,2,29.3,17.1,29.2h.6c35.4,0,64,28.7,64,64s28.7,64,64,64,33.9-7.3,45.5-19h.1q0-.1,0,0ZM168.1,118.9c-.9-14.5,11-26.4,25.5-25.5,11.9.8,21.6,10.4,22.4,22.4.9,14.5-11,26.4-25.5,25.5-11.9-.8-21.6-10.4-22.4-22.4Z"/>
    <path fill-opacity="0.5" d="M18.5,72.3C7.1,83.8,0,99.7,0,117.3s13.2,35.8,18.5,45c5.3,9.2,27.8,48.1,27.8,48.1,8.6,15,24.6,24.2,41.9,24.2h79.7c17.3,0,33.2-9.2,41.9-24.2h0c7.5-13.1-2-29.3-17.1-29.2h-.6c-35.4,0-64-28.7-64-64s-28.7-64-64-64-33.9,7.3-45.5,19h-.1q0,0,0,.1ZM87.9,115.7c.9,14.5-11,26.4-25.5,25.5-11.9-.8-21.6-10.4-22.4-22.4-.9-14.5,11-26.4,25.5-25.5,11.9.8,21.6,10.4,22.4,22.4Z"/>
  </g>
</svg>`;
